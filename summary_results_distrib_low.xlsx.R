...
# file name
fn_model_results <-
  "Model results - Distributed Core Low Flow 10-12-2018.xlsx"

# data range
# this is for day 7, 'Model results - Distributed Core Low Flow 10-12-2018.xlsx'
data_range <- "FW3:GW44"
...
write_excel_csv(DT_summary,
  path = paste0(wd_data, "summary_performance_distributed_low.csv"),
  na = "")
...
write_excel_csv(DT_relative,
                path = paste0(wd_data, "summary_relative_distributed_low.csv"),
                na = "")

# save the summary and relative data.tables in one file
save(DT_summary, DT_relative, 
     file = paste0(wd_data, "summary_relative_distributed_low.Rdata"))
