# chart_21_26.R
# a macro to make charts for table 21 & 26 from draft final report v.10
...
# Configuration to be listed in the gaps
# Identificaton to be used as the tick mark labels

# add an index to get the right order of data 
# since  neither Configuration or Identification is unique
# this is one letter per pair of columns
# these are the x values in the plot
DT_relative_long_chart[, Identification.values:= c(letters[1:8],letters[1:8])]
...
Identification.labels <- 
  c("", Identification.labels[1:2],   # Trunk & 3 Branches
