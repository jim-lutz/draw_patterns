...
# file name
fn_model_results <-
  "Model results - Compact Core Low Flow 10-12-2018.xlsx"

# data range
# this is for day 7, 'Model results - Compact Core Low Flow 10-12-2018.xlsx'
data_range <- "FW3:GW35"
...
write_excel_csv(DT_summary,
  path = paste0(wd_data, "summary_performance_compact_low.csv"),
  na = "")
...
write_excel_csv(DT_relative,
                path = paste0(wd_data, "summary_relative_compact_low.csv"),
                na = "")

# save the summary and relative data.tables in one file
save(DT_summary, DT_relative, 
     file = paste0(wd_data, "summary_relative_compact_low.Rdata"))
